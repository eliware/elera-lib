# Elera library examples

## Contents

- [Basic client](basic-client.mjs) — demonstrates the shared
  `@eliware/elera-lib` bundle-validation helper.

Run it with a complete bundle (including the required generated physical
schema):
