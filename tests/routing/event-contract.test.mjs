...
test('validates update bundles and endpoint syntax', () => {
  const bundle = { apiVersion: 'v1', application: 'a', database: 'd', identity: 'i', credentials: { username: 'u', password: 'p' }, writer: { host: 'w', port: 3306 }, readers: [], failover: [], bundleVersion: 1, expiresAt: '2099-01-01T00:00:00Z', nodeIdentity: 'w', ports: { sql: 3306, http: 8080 }, routes: { primary: [], balanced: [] } };
